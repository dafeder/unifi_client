...
| Get traffic stats by interval for a device type for site     | get_stats_for_site            | site, interval, element_type,stat_attributes,start_epoch_timestamp_ms, end_epoch_timestamp_ms,filter_mac_list | /api/s/{site}/stat/report/{interval}.{what} |       |
| Get site traffic stats in 5min interval bin                  | get_5min_site_all_stats       | site, start_epoch_timestamp_ms, end_epoch_timestamp_ms                                                        | /api/s/{site}/stat/report/5minutes.site     |       |
| Get ap traffic stats in 5min interval bin                    | get_5min_ap_all_stats         | site, start_epoch_timestamp_ms, end_epoch_timestamp_ms                                                        | /api/s/{site}/stat/report/5minutes.ap       |       |
| Get user traffic stats in 5min interval bin                  | get_5min_user_all_stats       | site, start_epoch_timestamp_ms, end_epoch_timestamp_ms                                                        | /api/s/{site}/stat/report/5minutes.user     |       |
| Get site traffic stats in hourly interval bin                | get_hourly_site_all_stats     | site, start_epoch_timestamp_ms, end_epoch_timestamp_ms                                                        | /api/s/{site}/stat/report/hourly.site       |       |
| Get ap traffic stats in hourly interval bin                  | get_hourly_ap_all_stats       | site, start_epoch_timestamp_ms, end_epoch_timestamp_ms                                                        | /api/s/{site}/stat/report/hourly.ap         |       |
| Get user traffic stats in hourly interval bin                | get_hourly_user_all_stats     | site, start_epoch_timestamp_ms, end_epoch_timestamp_ms                                                        | /api/s/{site}/stat/report/hourly.user       |       |
| Get site traffic stats in day interval bin                   | get_daily_site_all_stats      | site, start_epoch_timestamp_ms, end_epoch_timestamp_ms                                                        | /api/s/{site}/stat/report/daily.site        |       |
| Get ap traffic stats in day interval bin                     | get_daily_ap_all_stats        | site, start_epoch_timestamp_ms, end_epoch_timestamp_ms                                                        | /api/s/{site}/stat/report/daily.site        |       |
| Get user traffic stats in day interval bin                   | get_daily_user_all_stats      | site, start_epoch_timestamp_ms, end_epoch_timestamp_ms                                                        | /api/s/{site}/stat/report/daily.site        |       |
...
| Get traffic by catagroy and application for a site           | get_site_dpi_by_app           | site, filter_category_list                                                                                    | /api/s/{site}/stat/sitedpi                  |       |
| Get traffic by catagroy for a site                           | get_site_dpi_by_category      | site                                                                                                          | /api/s/{site}/stat/sitedpi                  |       |
| Get traffic by catagroy and application for a site by client | get_dpi_by_app                | site, filter_mac_list, filter_category_list                                                                   | /api/s/{site}/stat/statdpi                  |       |
| Get traffic by catagroy for a site by client                 | get_dpi_by_category           | site, filter_mac_list                                                                                         | /api/s/{site}/stat/statdpi                  |       |
